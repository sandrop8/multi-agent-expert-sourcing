...
- Name: Multi-Agent Chat Application >> should allow sending message with Enter key
- Location: /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:162:9
...
Locator: getByText('Response via Enter key')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Response via Enter key')

    at /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:178:64
```
...
- main:
  ...
  - textbox "Describe your project, skills needed, timeline, budget...": Test Enter key
  - button "Submit"
```
