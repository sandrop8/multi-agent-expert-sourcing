...
- Name: Multi-Agent Chat Application >> should load the chat interface correctly
- Location: /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:9:9
...
Call log:
  ...
  - waiting for getByText('Project Submission Chat')
    ...
    at /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:11:65
```
