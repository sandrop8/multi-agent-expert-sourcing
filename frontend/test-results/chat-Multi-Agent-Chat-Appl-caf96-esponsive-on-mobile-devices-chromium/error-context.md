...
- Name: Multi-Agent Chat Application >> should be responsive on mobile devices
- Location: /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:220:9
...
Locator: getByText('Project Submission Chat')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Project Submission Chat')
    - waiting for" http://localhost:3000/project" navigation to finish...
    - navigated to "http://localhost:3000/project"

    at /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:225:65
```
