...
- Name: Multi-Agent Chat Application >> should clear input after sending message
- Location: /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:36:9
...
Expected string: ""
Received string: "Test message"
Call log:
  - expect.toHaveValue with timeout 5000ms
  - waiting for getByPlaceholder('Describe your project, skills needed, timeline, budget...')
    9 × locator resolved to <input value="" data-slot="input" placeholder="Describe your project, skills needed, timeline, budget..." class="file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none dis…/>
      - unexpected value "Test message"

    at /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:53:29
```
