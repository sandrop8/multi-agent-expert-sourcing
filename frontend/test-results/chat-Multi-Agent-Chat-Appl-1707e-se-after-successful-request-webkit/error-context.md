...
Locator: getByText('This is an AI response from the expert sourcing system')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('This is an AI response from the expert sourcing system')

    at /Users/jensbosseparra/github_projects/multi-agent-expert-sourcing/frontend/e2e/chat.spec.ts:119:96
```
...
- main:
  ...
  - textbox "Describe your project, skills needed, timeline, budget...": Find me a Python developer
  - button "Submit"
```
