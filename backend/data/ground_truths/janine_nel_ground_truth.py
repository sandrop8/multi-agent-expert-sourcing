...
def extract_janine_nel_cv() -> Dict[str, Any]:
    ...
    personal_info = {
        ...
        "industries": [
            "Engineering",
            "Management, Sales & HR",
        ],  # From CV: "Engineering, Management, Sales & HR"
    ...
    skills_detailed = [
        ...
        {
            "skill_name": "Knowledge of Technical Diagrams",
            "skill_category": "technical",
        ...
        # Business skills
        {
            "skill_name": "Industry Trends & Sales Forecasting",
        ...
        {
            "skill_name": "Territory Management",
            "skill_category": "business",
            "proficiency_level": "advanced",
            "years_experience": None,
            "is_primary_skill": False,
    ...
    certifications = [
        ...
        },
        {
            ...
            "expiry_date": date(
                2021, 5, 31
            ),  # Same month expiry seems odd, but as listed
            "credential_id": None,
            "credential_url": None,
            "description": None,
        },
...
if __name__ == "__main__":
    ...
    if errors:
        ...
        print(
            f"  - Personal info: {janine_data['personal_info']['first_name']} {janine_data['personal_info']['last_name']}"
        )
        print(
            f"  - Employment history: {len(janine_data['employment_history'])} positions"
        )
        print(f"  - Education: {len(janine_data['education'])} degrees")
        print(f"  - Skills: {len(janine_data['skills_detailed'])} skills")
        print(
            f"  - Primary skills: {len([s for s in janine_data['skills_detailed'] if s['is_primary_skill']])}"
        )
        print(
            f"  - Certifications: {len(janine_data['certifications'])} certifications"
        )
        print(
            f"  - Extraction challenges: {len(janine_data['extraction_challenges'])} noted"
        )
