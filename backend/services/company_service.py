...
class CompanyService:
    ...
    def start_company_profiling_crew(
        self, website_url: str, background_tasks: BackgroundTasks
    ):
        """
        ...
        return {
            "message": "Company profiling process has been started in the background."
        }
