...
def upgrade() -> None:
    ...
    op.drop_constraint('cv_personal_info_cv_file_id_fkey', 'cv_personal_info', type_='foreignkey')
    op.drop_constraint('cv_professional_services_cv_file_id_fkey', 'cv_professional_services', type_='foreignkey')
    op.drop_constraint('cv_employment_cv_file_id_fkey', 'cv_employment', type_='foreignkey')
    op.drop_constraint('cv_education_cv_file_id_fkey', 'cv_education', type_='foreignkey')
    op.drop_constraint('cv_skills_cv_file_id_fkey', 'cv_skills', type_='foreignkey')
    op.drop_constraint('cv_certifications_cv_file_id_fkey', 'cv_certifications', type_='foreignkey')
    ...
    op.create_foreign_key('cv_personal_info_cv_id_fkey', 'cv_personal_info', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('cv_professional_services_cv_id_fkey', 'cv_professional_services', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('cv_employment_cv_id_fkey', 'cv_employment', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('cv_education_cv_id_fkey', 'cv_education', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('cv_skills_cv_id_fkey', 'cv_skills', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('cv_certifications_cv_id_fkey', 'cv_certifications', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('cv_projects_cv_id_fkey', 'cv_projects', 'cvs', ['cv_id'], ['id'], ondelete='CASCADE')
    ...
    op.drop_index('ix_cv_professional_services_cv_file_id', table_name='cv_professional_services')
    ...
    op.create_index(op.f('ix_cv_personal_info_cv_id'), 'cv_personal_info', ['cv_id'], unique=False)
    op.create_index(op.f('ix_cv_professional_services_cv_id'), 'cv_professional_services', ['cv_id'], unique=False)
    op.create_index(op.f('ix_cv_employment_cv_id'), 'cv_employment', ['cv_id'], unique=False)
    op.create_index(op.f('ix_cv_education_cv_id'), 'cv_education', ['cv_id'], unique=False)
    op.create_index(op.f('ix_cv_skills_cv_id'), 'cv_skills', ['cv_id'], unique=False)
    op.create_index(op.f('ix_cv_certifications_cv_id'), 'cv_certifications', ['cv_id'], unique=False)
    op.create_index(op.f('ix_cv_projects_cv_id'), 'cv_projects', ['cv_id'], unique=False)
