...
def upgrade() -> None:
    ...
    op.create_table('cv_certifications',
    ...
    op.create_index(op.f('ix_cv_certifications_cv_file_id'), 'cv_certifications', ['cv_file_id'], unique=False)
    op.create_index(op.f('ix_cv_certifications_id'), 'cv_certifications', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_cv_education_cv_file_id'), 'cv_education', ['cv_file_id'], unique=False)
    op.create_index(op.f('ix_cv_education_id'), 'cv_education', ['id'], unique=False)
    op.create_table('cv_employment',
    sa.Column('cv_file_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_cv_employment_cv_file_id'), 'cv_employment', ['cv_file_id'], unique=False)
    op.create_index(op.f('ix_cv_employment_id'), 'cv_employment', ['id'], unique=False)
    op.create_table('cv_personal_info',
    sa.Column('cv_file_id', sa.Integer(), nullable=False),
    ...
    sa.Column('hourly_rate_single', sa.DECIMAL(precision=8, scale=2), nullable=True),
    ...
    op.create_index(op.f('ix_cv_personal_info_cv_file_id'), 'cv_personal_info', ['cv_file_id'], unique=False)
    op.create_index(op.f('ix_cv_personal_info_id'), 'cv_personal_info', ['id'], unique=False)
    op.create_table('cv_professional_services',
    sa.Column('cv_file_id', sa.Integer(), nullable=False),
    sa.Column('management_sales_hr_services', postgresql.ARRAY(sa.String()), nullable=True),
    sa.Column('marketing_design_services', postgresql.ARRAY(sa.String()), nullable=True),
    ...
    op.create_index(op.f('ix_cv_professional_services_cv_file_id'), 'cv_professional_services', ['cv_file_id'], unique=False)
    op.create_index(op.f('ix_cv_professional_services_id'), 'cv_professional_services', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_cv_projects_cv_file_id'), 'cv_projects', ['cv_file_id'], unique=False)
    ...
    op.create_index(op.f('ix_cv_skills_cv_file_id'), 'cv_skills', ['cv_file_id'], unique=False)
    op.create_index(op.f('ix_cv_skills_id'), 'cv_skills', ['id'], unique=False)
    op.create_index(op.f('ix_cv_skills_skill_category'), 'cv_skills', ['skill_category'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_cv_professional_services_id'), table_name='cv_professional_services')
    op.drop_index(op.f('ix_cv_professional_services_cv_file_id'), table_name='cv_professional_services')
    ...
    op.drop_index(op.f('ix_cv_certifications_cv_file_id'), table_name='cv_certifications')
